...
export default function ProjectsPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-6 pt-28 pb-20">
      <p className="font-mono text-sm text-teal-600 mb-2">// projects</p>
      <h1 className="text-3xl font-bold text-gray-900 mb-2">All Projects</h1>
      <p className="text-gray-500 text-sm mb-8">{projects.length} projects · all deployed live</p>
          ...
          >
            <div>
              <div className="flex items-start justify-between gap-2">
                ...
                {project.featured && (
                  <span className="text-xs px-1.5 py-0.5 bg-teal-50 text-teal-700 border border-teal-100 rounded flex-shrink-0">
                    Featured
                  </span>
                )}
              </div>
